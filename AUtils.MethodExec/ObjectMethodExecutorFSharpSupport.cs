...
{
    private static object sFsharpValuesCacheLock = new object();
    private static Assembly sFsharpCoreAssembly;
    private static MethodInfo sFsharpAsyncStartAsTaskGenericMethod;
    private static PropertyInfo sFsharpOptionOfTaskCreationOptionsNoneProperty;
    private static PropertyInfo sFsharpOptionOfCancellationTokenNoneProperty;
        ...
        out Type awaitableType)
    {
        ...
        // };
        var startAsTaskClosedMethod = sFsharpAsyncStartAsTaskGenericMethod
        ...
        coerceToAwaitableExpression = Expression.Lambda(
            Expression.Convert(
                Expression.Call(
                    ...
                    Expression.MakeMemberAccess(null, sFsharpOptionOfTaskCreationOptionsNoneProperty),
                    Expression.MakeMemberAccess(null, sFsharpOptionOfCancellationTokenNoneProperty)),
                typeof(object)),
    ...
    private static bool IsFSharpAsyncOpenGenericType(Type possibleFSharpAsyncGenericType)
    {
        ...
        lock (sFsharpValuesCacheLock)
        {
            if (sFsharpCoreAssembly != null)
            {
                ...
                return possibleFSharpAsyncGenericType.Assembly == sFsharpCoreAssembly;
            }
            else
            {
    ...
    private static bool TryPopulateFSharpValueCaches(Type possibleFSharpAsyncGenericType)
    {
        ...
        sFsharpOptionOfTaskCreationOptionsNoneProperty = fsharpOptionOfTaskCreationOptionsType
        ...
        sFsharpOptionOfCancellationTokenNoneProperty = fsharpOptionOfCancellationTokenType
            .GetRuntimeProperty("None");
        ...
        foreach (var candidateMethodInfo in fsharpAsyncMethods)
        {
                ...
                && parameters[2].ParameterType == fsharpOptionOfCancellationTokenType)
            {
                ...
                sFsharpAsyncStartAsTaskGenericMethod = candidateMethodInfo;
                sFsharpCoreAssembly = assembly;
                break;
            }
        }

        return sFsharpCoreAssembly != null;
    }
