...
// Copied from https://github.com/dotnet/aspnetcore/tree/main/src/Shared/ObjectMethodExecutor
...
{
    private readonly object mCustomAwaitable;
    private readonly Func<object, object> mGetAwaiterMethod;
    private readonly Func<object, bool> mIsCompletedMethod;
    private readonly Func<object, object> mGetResultMethod;
    private readonly Action<object, Action> mOnCompletedMethod;
    private readonly Action<object, Action> mUnsafeOnCompletedMethod;
    ...
    {
        mCustomAwaitable = customAwaitable;
        mGetAwaiterMethod = getAwaiterMethod;
        mIsCompletedMethod = isCompletedMethod;
        mGetResultMethod = getResultMethod;
        mOnCompletedMethod = onCompletedMethod;
        mUnsafeOnCompletedMethod = unsafeOnCompletedMethod;
    }

    public Awaiter GetAwaiter()
    {
        var customAwaiter = mGetAwaiterMethod(mCustomAwaitable);
        return new Awaiter(customAwaiter, mIsCompletedMethod, mGetResultMethod, mOnCompletedMethod, mUnsafeOnCompletedMethod);
    }

    public readonly struct Awaiter : ICriticalNotifyCompletion
    {
        private readonly object mCustomAwaiter;
        private readonly Func<object, bool> mIsCompletedMethod;
        private readonly Func<object, object> mGetResultMethod;
        private readonly Action<object, Action> mOnCompletedMethod;
        private readonly Action<object, Action> mUnsafeOnCompletedMethod;
        ...
        public bool IsCompleted => mIsCompletedMethod(mCustomAwaiter);

        public object GetResult() => mGetResultMethod(mCustomAwaiter);

        public void OnCompleted(Action continuation)
        {
            mOnCompletedMethod(mCustomAwaiter, continuation);
        }
        ...
        public void UnsafeOnCompleted(Action continuation)
        {
            ...
            var underlyingMethodToUse = mUnsafeOnCompletedMethod ?? mOnCompletedMethod;
            underlyingMethodToUse(mCustomAwaiter, continuation);
        }
    }
}