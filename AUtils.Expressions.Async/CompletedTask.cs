...
{
    private readonly Exception? mFailure;
    ...
    public CompletedTask(Exception failure) => mFailure = failure;
    ...
    public static implicit operator Task(CompletedTask task)
        => task.mFailure is null ? Task.CompletedTask : Task.FromException(task.mFailure);
    ...
    public static implicit operator ValueTask(CompletedTask task)
        => task.mFailure is null ? ValueTask.CompletedTask : ValueTask.FromException(task.mFailure);
}
